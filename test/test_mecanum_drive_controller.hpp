...
using ControllerStateMsg =
    mecanum_drive_controller::MecanumDriveController::ControllerStateMsg;
...
using OdomStateMsg =
    mecanum_drive_controller::MecanumDriveController::OdomStateMsg;
...
class TestableMecanumDriveController
    : public mecanum_drive_controller::MecanumDriveController {
  FRIEND_TEST(MecanumDriveControllerTest,
...
public:
  ...
  on_configure(const rclcpp_lifecycle::State &previous_state) override {
    auto ret = mecanum_drive_controller::MecanumDriveController::on_configure(
        previous_state);
    return ret;
  }
  ...
  on_activate(const rclcpp_lifecycle::State &previous_state) override {
    ...
    return mecanum_drive_controller::MecanumDriveController::on_activate(
        previous_state);
  }
   ...
   * timeout.
   */
  void wait_for_command(rclcpp::Executor &executor,
  ...
  void wait_for_commands(rclcpp::Executor &executor,
                         const std::chrono::milliseconds &timeout =
                             std::chrono::milliseconds{500}) {
  ...
  void SetUp() {
    ...
    command_publisher_ =
        command_publisher_node_->create_publisher<ControllerReferenceMsg>(
            "/test_mecanum_drive_controller/reference",
    ...
    tf_odom_s_publisher_ =
        tf_odom_s_publisher_node_->create_publisher<TfStateMsg>(
            "/test_mecanum_drive_controller/tf_odometry",
            rclcpp::SystemDefaultsQoS());
  }
...
protected:
  void SetUpController(
    ...
    const auto urdf = "";
    const auto ns = "";
    ASSERT_EQ(controller_->init(controller_name, urdf, 0, ns,
  ...
  void subscribe_to_controller_status_execute_update_and_get_messages(
    ...
    auto subs_callback = [&](const ControllerStateMsg::SharedPtr cbmsg) {
      received_msg = cbmsg;
    };
    auto subscription =
        test_subscription_node.create_subscription<ControllerStateMsg>(
            "/test_mecanum_drive_controller/controller_state", 10,
            subs_callback);
...
protected:
  ...
  static constexpr char TEST_FRONT_LEFT_CMD_JOINT_NAME[] =
      "front_left_wheel_joint";
  static constexpr char TEST_FRONT_RIGHT_CMD_JOINT_NAME[] =
      "front_right_wheel_joint";
  static constexpr char TEST_REAR_RIGHT_CMD_JOINT_NAME[] =
      "back_right_wheel_joint";
  static constexpr char TEST_REAR_LEFT_CMD_JOINT_NAME[] =
      "back_left_wheel_joint";
  std::vector<std::string> command_joint_names_ = {
      TEST_FRONT_LEFT_CMD_JOINT_NAME, TEST_FRONT_RIGHT_CMD_JOINT_NAME,
      TEST_REAR_RIGHT_CMD_JOINT_NAME, TEST_REAR_LEFT_CMD_JOINT_NAME};

  static constexpr char TEST_FRONT_LEFT_STATE_JOINT_NAME[] =
      "state_front_left_wheel_joint";
  static constexpr char TEST_FRONT_RIGHT_STATE_JOINT_NAME[] =
      "state_front_right_wheel_joint";
  static constexpr char TEST_REAR_RIGHT_STATE_JOINT_NAME[] =
      "state_back_right_wheel_joint";
  static constexpr char TEST_REAR_LEFT_STATE_JOINT_NAME[] =
      "state_back_left_wheel_joint";
